...
stepSimLADSmoothFirst <- function(contamination, n, p = 4, Nm = 0, c = 0.5, sigma = 0.5, alpha = 0.05, strength = 10, correction = 0, debug = FALSE) { 
  #Constants ----
  ...
  for (a in 1 : maxSim){
    ...
    sample <- rbind(generateSample1(n.real, N, sigma), generateOutlierStep(numberOfSamples =  n.out, N, start = 0.5, strength = strength, sigma))
